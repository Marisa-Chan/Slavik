...
${OBJECTDIR}/common/strutils.o: common/strutils.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include -I/usr/include/c++/13.2.1 -I/usr/include/c++/13.2.1/x86_64-pc-linux-gnu `pkg-config --cflags sdl2` `pkg-config --cflags opengl` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/strutils.o common/strutils.cpp

${OBJECTDIR}/fmt/format.o: fmt/format.cc
	${MKDIR} -p ${OBJECTDIR}/fmt
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include -I/usr/include/c++/13.2.1 -I/usr/include/c++/13.2.1/x86_64-pc-linux-gnu `pkg-config --cflags sdl2` `pkg-config --cflags opengl` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fmt/format.o fmt/format.cc
...
${OBJECTDIR}/fsmgr.o: fsmgr.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include -I/usr/include/c++/13.2.1 -I/usr/include/c++/13.2.1/x86_64-pc-linux-gnu `pkg-config --cflags sdl2` `pkg-config --cflags opengl` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fsmgr.o fsmgr.cpp
...
${OBJECTDIR}/game_loot.o: game_loot.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include -I/usr/include/c++/13.2.1 -I/usr/include/c++/13.2.1/x86_64-pc-linux-gnu `pkg-config --cflags sdl2` `pkg-config --cflags opengl` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/game_loot.o game_loot.cpp
...
${OBJECTDIR}/game_placeoff.o: game_placeoff.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include -I/usr/include/c++/13.2.1 -I/usr/include/c++/13.2.1/x86_64-pc-linux-gnu `pkg-config --cflags sdl2` `pkg-config --cflags opengl` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/game_placeoff.o game_placeoff.cpp

${OBJECTDIR}/game_play.o: game_play.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include -I/usr/include/c++/13.2.1 -I/usr/include/c++/13.2.1/x86_64-pc-linux-gnu `pkg-config --cflags sdl2` `pkg-config --cflags opengl` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/game_play.o game_play.cpp

${OBJECTDIR}/game_state.o: game_state.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include -I/usr/include/c++/13.2.1 -I/usr/include/c++/13.2.1/x86_64-pc-linux-gnu `pkg-config --cflags sdl2` `pkg-config --cflags opengl` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/game_state.o game_state.cpp

${OBJECTDIR}/game_village.o: game_village.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include -I/usr/include/c++/13.2.1 -I/usr/include/c++/13.2.1/x86_64-pc-linux-gnu `pkg-config --cflags sdl2` `pkg-config --cflags opengl` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/game_village.o game_village.cpp

${OBJECTDIR}/gfx.o: gfx.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include -I/usr/include/c++/13.2.1 -I/usr/include/c++/13.2.1/x86_64-pc-linux-gnu `pkg-config --cflags sdl2` `pkg-config --cflags opengl` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gfx.o gfx.cpp
...
${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include -I/usr/include/c++/13.2.1 -I/usr/include/c++/13.2.1/x86_64-pc-linux-gnu `pkg-config --cflags sdl2` `pkg-config --cflags opengl` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp

${OBJECTDIR}/resources.o: resources.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include -I/usr/include/c++/13.2.1 -I/usr/include/c++/13.2.1/x86_64-pc-linux-gnu `pkg-config --cflags sdl2` `pkg-config --cflags opengl` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/resources.o resources.cpp

${OBJECTDIR}/system.o: system.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include -I/usr/include/c++/13.2.1 -I/usr/include/c++/13.2.1/x86_64-pc-linux-gnu `pkg-config --cflags sdl2` `pkg-config --cflags opengl` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/system.o system.cpp
