...
${OBJECTDIR}/cp866.o: cp866.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags opengl` `pkg-config --cflags SDL2_image`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cp866.o cp866.cpp
...
${OBJECTDIR}/game_arrows.o: game_arrows.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags opengl` `pkg-config --cflags SDL2_image`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/game_arrows.o game_arrows.cpp
...
${OBJECTDIR}/game_sound.o: game_sound.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags opengl` `pkg-config --cflags SDL2_image`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/game_sound.o game_sound.cpp
...
${OBJECTDIR}/game_trade.o: game_trade.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags sdl2` `pkg-config --cflags opengl` `pkg-config --cflags SDL2_image`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/game_trade.o game_trade.cpp
